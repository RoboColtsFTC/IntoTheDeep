...
public final class MecanumDrive {
    public static class Params {
        ...
        public double kV = 0.0005979827929821677;
        public double kA = 0;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "drive_LF");
        leftBack = hardwareMap.get(DcMotorEx.class, "drive_LR");
        rightBack = hardwareMap.get(DcMotorEx.class, "drive_RR");
        rightFront = hardwareMap.get(DcMotorEx.class, "drive_RF");
